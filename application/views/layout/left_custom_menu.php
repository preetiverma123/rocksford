<div class="">
    <div class="left_col scroll-view">
        ...
        <div class="clearfix navbar_brand"></div>        
            ...
            <div class="menu_section">
                ...
                <ul class="nav side-menu">  
                   ...
                   <?php } ?>
                    ...
                    <?php } ?>
                   <?php if(!empty($page_name) && $page_name=='facility'){ ?>
                        <li><a href="<?php echo site_url('facility'); ?>"><i class="fa fa-users"></i> <?php echo 'Facility'; ?></a> </li>  
                   <?php } ?>
                    ...
                    <?php if(!empty($page_name) && $page_name=='student'){ ?>  
                        <li><a><i class="fa fa-group"></i> <?php echo $this->lang->line('student'); ?> <span class="fa fa-chevron-down"></span></a>
                            <ul class="nav child_menu">
                                ...
                                <?php if(has_permission(ADD, 'student', 'student')){ ?>
                                    <li><a href="<?php echo site_url('student/print/'); ?>"> <?php echo $this->lang->line('print'); ?> <?php echo $this->lang->line('student'); ?> Cards</a></li>
                                <?php } ?>  
                 ...
                 <?php if(!empty($page_name) && $page_name=='exam'){ ?>   
                  ...
                  <?php if(!empty($page_name) && $page_name=='mail_and_sms'){ ?>
                               ...
                               <?php if(has_permission(VIEW, 'accounting', 'incomehead')){ ?>
                                ...
                                <?php if(has_permission(VIEW, 'accounting', 'invoice')){ ?>
                                    ...
                                    <?php }else{ ?>
                                        ...
                                        <li><a href="<?php echo site_url('accounting/invoice/due'); ?>"><?php echo $this->lang->line('due_invoice'); ?></a></li>
                                        <li><a href="<?php echo site_url('accounting/invoice/ledger'); ?>"><?php echo 'Student Ledger'; ?></a></li>
                                    <?php } ?>
                   ...
                   <?php if(!empty($page_name) && $page_name=='gallery'){ ?>
