                                ...
                                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo date('M j,Y', strtotime($profile->dob)); ?></td>
                                        </tr>                                                                                
                                        <tr>
                                            <th><?php echo $this->lang->line('join_date'); ?></th>
                                            <td><?php echo date('M j,Y', strtotime($profile->joining_date)); ?></td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?php echo UPLOAD_PATH; ?>/employee-resume/<?php echo $profile->resume; ?>"><?php echo $this->lang->line('download'); ?></a> 
                                                <?php } ?>
                                            </td>
                                            <th><?php echo $this->lang->line('resign_date'); ?></th>
                                            <td><?php echo $profile->resign_date != ''  ? date('M j,Y', strtotime($profile->resign_date)) : ''; ?></td>
                                        </tr>                                                                                
                           ...
                           <div class="x_content"> 
                            <?php echo form_open_multipart(site_url('profile/update/'. $profile->id), array('name' => 'profile', 'id' => 'profile', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12" name="designation_id" id="designation_id" required="required">
                                            ...
                                            <?php foreach($designations as $obj){ ?>
                                                <option value="<?php echo $obj->id; ?>" <?php if($profile->designation_id == $obj->id){ echo 'selected="selected"';} ?>><?php echo $obj->name; ?></option>
                                            <?php } ?>
                                        </select>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea  class="form-control col-md-7 col-xs-12"  name="present_address"  id="present_address" placeholder="<?php echo $this->lang->line('present'); ?> <?php echo $this->lang->line('address'); ?>"><?php echo isset($profile->present_address) ?  $profile->present_address : '' ?></textarea>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea  class="form-control col-md-7 col-xs-12"  name="permanent_address"  id="permanent_address" placeholder="<?php echo $this->lang->line('permanent'); ?> <?php echo $this->lang->line('address'); ?>"><?php echo isset($profile->permanent_address) ?  $profile->permanent_address : ''; ?></textarea>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <?php if($profile->resume){ ?>
                                        <a href="<?php echo UPLOAD_PATH; ?>/employee-resume/<?php echo $profile->resume; ?>"><?php echo $profile->resume; ?></a> <br/><br/>
                                        <?php } ?>
                                        <div class="btn btn-default btn-file">
                                            <i class="fa fa-paperclip"></i> <?php echo $this->lang->line('upload'); ?>
