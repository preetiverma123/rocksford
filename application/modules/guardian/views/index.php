                        ...
                        <div class="tab-pane fade in active" id="tab_edit_guardian">
                            ...
                            <?php echo form_open_multipart(site_url('guardian/edit/'. $guardian->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="email" readonly="readonly"  id="email" value="<?php echo isset($guardian->email) ?  $guardian->email : (isset($post['email'])?$post['email']:''); ?>" placeholder="<?php echo $this->lang->line('email'); ?>"  type="email">
                                        <div class="help-block"><?php echo form_error('email'); ?></div>
                                    </div>
                                </div>
