    ...
    public function assignment() {
        ...
        if ($this->input->post('id')) {
            ...
            if ($_FILES['assignment']['name']) {
                ...
                if ($ext == 'pdf' || $ext == 'doc' || $ext == 'docx' || $ext == 'txt' || $ext == 'jpg'  || $ext == 'jpeg' || $ext == 'png') {
                    return TRUE;
                } else {
    ...
    private function _upload_assignment() {
        ...
        if ($assignment != "") {
            if ($assignment_type == 'application/vnd.openxmlformats-officedocument.wordprocessingml.document' ||
                    ...
                    $assignment_type == 'application/vnd.ms-office' || $assignment_type == 'application/pdf' || $assignment_type == 'image/jpeg' ||$assignment_type == 'image/jpg' || $assignment_type == 'image/png') {
