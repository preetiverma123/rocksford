                    ...
                    <div class="tab-content">
                                    ...
                                    <?php  $count = 1; if(isset($students) && !empty($students)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $obj->section; ?></td>
                                             <td><?php echo !empty($obj->roll_no)?$obj->roll_no:''; ?></td>
                                            <td><?php echo $obj->registration_no; ?></td>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_student">
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('student/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12" name="guardian_id" id="guardian_id" required="required" onchange="get_guardian_by_id(this.value);">
                                            ...
                                            <?php foreach($guardians as $obj){ ?>
                                                <option value="<?php echo $obj->id; ?>" <?php echo isset($post['guardian_id']) && $post['guardian_id'] == $obj->id ?  'selected="selected"' : ''; ?>><?php echo $obj->name.'-('.$obj->phone.')'; ?></option>
                                            <?php } ?>
                                        </select>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name"><?php echo 'Mothers name'; ?> 
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="mothers_name"  id="mothers_name" value="<?php echo isset($post['mothers_name']) ?  $post['mothers_name'] : ''; ?>" placeholder="<?php echo 'mothers_name'; ?>"  type="text">
                                        <div class="help-block"><?php echo form_error('mothers_name'); ?></div>
                                    </div>
                                </div>
                                
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="dob"><?php echo $this->lang->line('birth_date'); ?> 
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="dob"  id="add_dob" value="<?php echo isset($post['dob']) ?  $post['dob'] : ''; ?>" placeholder="<?php echo $this->lang->line('birth_date'); ?>" type="text">
                                        <div class="help-block"><?php echo form_error('dob'); ?></div>
                                    </div>
                                </div>
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="gender"><?php echo $this->lang->line('gender'); ?> </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="registration_no"><?php echo $this->lang->line('registration_no'); ?><span class="required">*</span>
                                    </label>
                                    <?php $reg_no = rand((int)1111111111,(int) 9999999999); ?>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="registration_no"  id="registration_no" required="required" value="<?php echo isset($post['registration_no']) ?  $post['registration_no'] : $reg_no; ?>" placeholder="<?php echo $this->lang->line('registration_no'); ?>" type="text">
                                        <div class="help-block"><?php echo form_error('registration_no'); ?></div>
                                    </div>
                                </div>   
                                
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="roll_no"><?php echo $this->lang->line('previous').' '.$this->lang->line('amount'); ?> 
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="previous_due"  id="previous_due" value="<?php echo isset($post['previous_due']) ?  $post['previous_due'] : ''; ?>" placeholder="<?php echo  $this->lang->line('previous').' '.$this->lang->line('amount'); ?>" type="text">
                                        <div class="help-block"><?php echo form_error('previous_due'); ?></div>
                                    </div>
                                </div> 
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="email"><?php echo $this->lang->line('email'); ?>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="password"><?php echo $this->lang->line('password'); ?> 
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="password"  id="password" value="123456" placeholder="<?php echo $this->lang->line('password'); ?>"  type="text">
                        ...
                        <div class="tab-pane fade in active" id="tab_edit_student">
                            ...
                            <?php echo form_open_multipart(site_url('student/edit/'. $student->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="mothers_name"><?php echo 'Mothers_name'; ?>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="mothers_name"  id="mothers_name" value="<?php echo isset($student->mothers_name) ?  $student->mothers_name : (!empty($post['mothers_name'])?$post['mothers_name']:''); ?>" placeholder="<?php echo 'mothers_name'; ?>"  type="text">
                                        <div class="help-block"><?php echo form_error('mothers_name'); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="dob"  id="edit_dob" value="<?php echo !empty($student->dob) ?  date('d-m-Y', strtotime($student->dob)) : (isset($post['dob'])?$post['dob']:''); ?>" placeholder="<?php echo $this->lang->line('birth_date'); ?>"  type="text">
                                        <div class="help-block"><?php echo form_error('dob'); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="phone"  id="phone" value="<?php echo isset($student->phone) ?  $student->phone : (isset($post['phone'])?$post['phone']:''); ?>" placeholder="<?php echo $this->lang->line('phone'); ?>" type="text">
                                        <div class="help-block"><?php echo form_error('phone'); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="registration_no"  id="registration_no" readonly="readonly" value="<?php echo isset($student->registration_no) ?  $student->registration_no : $post['registration_no']; ?>" placeholder="<?php echo $this->lang->line('registration_no'); ?>"  type="text">
                                        <div class="help-block"><?php echo form_error('registration_no'); ?></div>
                                    </div>
                                </div>   
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="email" readonly="readonly"  id="email" value="<?php echo isset($student->email) ?  $student->email : (isset($post['email'])?$post['email']:''); ?>" placeholder="<?php echo $this->lang->line('email'); ?>"  type="email">
                                        <div class="help-block"><?php echo form_error('email'); ?></div>
                                    </div>
                                </div>
                        ...
                        <div class="tab-pane fade in active" id="tab_view_student">
                            ...
                            <?php echo form_open_multipart(site_url(), array('name' => 'detail', 'id' => 'detail', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                 ...
                                 <div class="item form-group">
                                    <label class="col-md-3 col-sm-3 col-xs-4"><?php echo 'Mothers_name'; ?></label>
                                    <div class="col-md-9 col-sm-9 col-xs-8">
                                    : <?php echo ($student->mothers_name)?$student->mothers_name:''; ?>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-8">
                                    : <?php echo !empty($student->dob)?(date('M j, Y', strtotime($student->dob))):''; ?>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-8">
                                    : <?php  echo !empty($student->gender)?($this->lang->line($student->gender)):''; ?>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-8">
                                    : <?php echo !empty($student->phone)?$student->phone:''; ?>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-8">
                                    : <?php echo !empty($student->email)?$student->email:''; ?>
                                    </div>
                                </div>
...
<!-- datatable with buttons -->
 ...
 <script type="text/javascript">
    ...
    $("#name").on('keyup',function(){
        ...
        value=value+randomno+"@gmail.com";
           $("#email").val(value); 
   });   
</script>