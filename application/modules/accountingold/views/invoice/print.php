			                                            ...
			                                            <table cellpadding="0" cellspacing="0" style="width: 100%">
			                                                <tbody>
			                                                	...
			                                                	<td align="left" style="width: 90px;">
			                                                    	<img src="<?php echo UPLOAD_PATH; ?>/logo/<?php echo $settings->logo; ?>" alt="logo" 
    height="60px"
>  
			                                                    </td>
			                                                    <td rowspan="2" align="right" style="padding-right: 5px">
			                                    ...
			                                    <tr>
			                                        <td colspan="2">
			                                            <div id="DataList1_ctl00_Panel1" style="height:130px;width:100%;">
				                                            <div>
	                                                ...
	                                                <tbody>
		                                            	...
		                                            	<?php }?>
		                                               	<tr>
		                                                    ...
		                                                    <td align="right">
		                                                        <span id="DataList1_ctl00_lblNetAmount" style="font-weight: 700"><?php echo $value->net_amount;?></span>
		                                                    </td>
	                                                	</tr>
	                                            	</tbody>
	                                        	</table>
