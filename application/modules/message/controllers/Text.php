    ...
    * ********************************************************** */
    public function _send($sms_gateway, $phone, $message) {
        ...
        if ($sms_gateway == "clicktell") {
            ...
            curl_setopt($ch, CURLOPT_POSTFIELDS, 'user=' . $username . '&password=' . $password . '&mobile=' . $phone . '&message=' . urlencode($message) . '&sender=' . $sender . '&type=3');
