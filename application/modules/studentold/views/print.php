...
<body style="margin: 0px; padding: 0px; font-family: Verdana; height: 100%; width: 100%;
    ...
    <div align="center" class="printhide"><a href="javascript:void(0)" onclick="PrintDiv()" id="hrefPrint">Print</a></div>
	<table width="100%"  id="printTable">
		<tbody>
			<tr>
        <td align="center">
           <!--  <div><a style="font-size: small; font-family: Verdana; font-weight: bold" href="javascript:void(0)" onclick="PrintDiv()" id="hrefPrint">Print</a></div> -->
        </td>
      </tr>
      <?php if($print_id=='identity'){ ?>
      <tr>
        <td align="center">
            <div id="printdiv" style="width: 800px">
                                  ...
                                  <tr>
		                                <td align="center" valign="top" style="padding:5px;border-bottom:1px solid #3995d4;">
		                                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
				                                <tbody>
				                                  <tr>
					                                  <td width="21%" height="75" align="left" valign="top">
            ...
            <?php } ?>
            <?php if($print_id=='admit'){ ?>
            <tr>
      <td align="center">
        <div id="printdiv" align="center" style="width: 800px">
          <table id="DataList1" cellspacing="0" cellpadding="0" ordercolor="Black" border="0" style="color:black;height:100%;width:100%;border-collapse:collapse;"><tbody>
          <tr>
          <td>
