                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <div class="tab-content">
                        <div  class="tab-pane fade in <?php if(isset($list)){ echo 'active'; }?>" id="tab_invoice_list" >
                            <?php echo form_open_multipart(site_url('accounting/invoice/get_filter_data'), array('date' => 'date', 'class' => 'form-horizontal form-label-left'), ''); ?>
                    <div class="row">
                    ...
                    <?php echo form_open_multipart(site_url('accounting/invoice/index')); ?>
                    ...
                    <?php echo form_close(); ?>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($bulk)){ echo 'active'; }?>" id="tab_bulk_invoice">
                            <div class="x_content"> 
                               ...
                               <input type="hidden" name="print" id="form_type" value="">
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-3">
                                        ...
                                        <button id="send" type="submit" class="btn btn-success invoicecreate"><?php echo $this->lang->line('submit'); ?></button>

                                        <!-- <a target="_blank" href="<?php echo site_url('student/generatePrintAll/'.$class_id.'/'.$section_id.'/'.$print_id.'/'.'none'); ?>"  class="btn btn-success btn-xs"><i class="fa fa-certificate"> <?php echo $this->lang->line('generate'); ?> All</i></a> -->

                                        <button type="submit" class="btn btn-success" id="print"  target="_blank"><?php echo $this->lang->line('print'); ?></button>
                                    </div>
                                </div>
                                <?php echo form_close(); ?>
                            </div>
