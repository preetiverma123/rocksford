...
class Invoice_Model extends MY_Model {
    ...
    public function get_invoice_list_where($due=NULL,$month,$year,$class_id=NULL,$section_id=NULL){
        
        $this->db->select('I.*, S.name AS student_name,E.*, AY.session_year, C.name AS class_name');
        $this->db->from('invoices AS I');        
        $this->db->join('classes AS C', 'C.id = I.class_id', 'left');
        $this->db->join('students AS S', 'S.id = I.student_id', 'left');
        $this->db->join('academic_years AS AY', 'AY.id = I.academic_year_id', 'left');
