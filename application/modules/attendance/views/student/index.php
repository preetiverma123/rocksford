            ...
            <div class="x_content">
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                    ...
                    <tbody id="fn_attendance">   
                        ...
                        if (isset($students) && !empty($students)) {
                            ...
                            <?php  $attendance = get_student_attendance($obj->id, $academic_year_id, $class_id, $section_id, $year, $month, $day ); ?>
                                <tr>
                                    ...
                                    <td><input type="radio" data-id = "<?php echo $obj->id; ?>" value="P" itemid="<?php echo $obj->id; ?>" name="student_<?php echo $obj->id; ?>" class="present fn_single_attendnce" <?php if($attendance == 'P'){ echo 'checked="checked"'; } ?> /></td>
                                    <td><input type="radio" data-id = "<?php echo $obj->id; ?>" value="L" itemid="<?php echo $obj->id; ?>"  name="student_<?php echo $obj->id; ?>" class="late fn_single_attendnce" <?php if($attendance == 'L'){ echo 'checked="checked"'; } ?>/></td>
                                    <td><input type="radio" data-id = "<?php echo $obj->id; ?>" value="A" itemid="<?php echo $obj->id; ?>" name="student_<?php echo $obj->id; ?>" class="absent fn_single_attendnce" <?php if($attendance == 'A'){ echo 'checked="checked"'; } ?>/></td>
                                </tr>
                            <?php } ?>
                        <?php }else{ ?>
                                <tr>
                        ...
                        <?php } ?>
                        <tr><td colspan="9"><button onclick="javascript: return confirm('<?php echo 'Do you want to send a text message of attendance to all the parents of students?'; ?>');" class="send-message-to-all btn btn-success">Send Text</button><td></tr>
                    </tbody>
                </table>
            </div> 
  ...
  $(document).ready(function(){
       ...
       $('.fn_single_attendnce').click(function(){
        ...
        $('.send-message-to-all').click(function(){
          ...
          $.ajax({       
            type   : "POST",
            url    : "<?php echo site_url('attendance/student/send_message'); ?>",
